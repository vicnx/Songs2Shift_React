...
export const SSMenubar = () =>{
  ...
  const end = (
    ...
    <span style={{ marginRight: 10 }}>Aplicaciones conectadas:</span>
      ...
      <FontAwesomeIcon icon={faDeezer} size="lg" style={{ marginRight: 10, cursor: 'pointer', color: (deezerToken ? 'orange': null) }} onClick={() =>!deezerToken ? navigate(CONSTANTS.routes.loginDeezer) : null}/>
    </>
  );
